## -------------------------------------------------------------
##
## Script name: Data for GDM from spOccupancy
##
...
OccData <- readRDS(here("./Data/SpOccupancy_Data/SpOccData_SpeciesThresh_975minMaxPrex_NewVars.rds"))
str(OccData)
## Package the Zs up
## Z matrix
...
sp.trait <- readRDS("R:/Users/skeyser/PostDoc/spOccupancy/TrialSpeciesOrder.rds")
